...
@Composable
fun EditarPreguntaScreen(preguntaMod: Pregunta, userId: String, navController: NavHostController) {
    ...
    LazyColumn(
        ...
        item {
            Text("Editar Pregunta", style = MaterialTheme.typography.titleLarge)
        }
