...
fun TrueFalseQuestionScreen(
    ...
    val isCorrectTrue = correctAnswer == stringResource(R.string.verdadero)
    val isCorrectFalse = correctAnswer == stringResource(R.string.falso)
    ...
    Row(
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                ...
                containerColor = if (isAcceptButtonClicked && immediateResults && correctAnswer == stringResource(R.string.verdadero) ||
                    !immediateResults && quizTerminado && correctAnswer == stringResource(R.string.verdadero)) Color.Green else trueButtonColor
            ),
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = if (isAcceptButtonClicked && immediateResults && correctAnswer == stringResource(R.string.falso) ||
                    !immediateResults && quizTerminado && correctAnswer == stringResource(R.string.falso)) Color.Green else falseButtonColor
            ),
